...
var UserSchema = new Schema({
   ...
   , customer: { profileId: String, paymentId: String, updated: { type: Date, default: Date.now } }

   , authToken: { type: String, required: true }

   , utilityCredentials: [{
      providerId: { type: Schema.ObjectId, ref: "UtilityProvider" }
      , fields: {}
   }]
...
// TODO: Don't return salts or hashes
